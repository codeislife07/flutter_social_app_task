...
class AppColorsBoostrap {
  ...
  static const Color primary = Color(0xFF2962FF); // Blue
  static const Color primary1 = Colors.purpleAccent; // Dark gray text
  static const Color secondary = Color(0xFF0a2540); // Gray
...
/// Color env config
Color? get darkBackgroundColor => Colors.white;

Color? get darkPrimaryColorLight => Colors.red;

Color? get darkTextColor => Colors.white;

Color? get darkSecondaryColor => Colors.red;
...
// const kLightBG = Color(0xfff6f9fc);
const kDarkBG = Color(0xFF121015);
const kDarkBgLight = Color(0xFF1E1E2E);
